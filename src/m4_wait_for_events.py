...
def sum_until_prime_input():
    ...
    # -------------------------------------------------------------------------
    yeet = input("Input an integer greater than 1: ")
    yeet = int(yeet)
    sum = 0
    while is_prime(yeet) is False:
        sum = yeet + sum
        yeet = input("Input an integer greater than 1: ")
        yeet = int(yeet)
    sum = sum + yeet
...
def prime_gap(m):
    ...
    num = 2
    while True:
        if next_prime(num + 1) - next_prime(num) >= m:
            break
        else:
            num = num + 1
    return num
...
def run_test_wait_for_sum_of_cubes():
    ...
    print('TEST STARTED!  Has it ended?')
    expected = 1
    actual = wait_for_sum_of_cubes(-100000000000000000000000000000000)
    print('Expected:', expected)
    print('Actual:  ', actual)
    print('TEST ENDED!')
...
def wait_for_sum_of_cubes(x):
    ...
    sum = 0
    total = 1
    for k in range(1,1000000000000000000000000):
        if k**3 + sum >= x:
            return total
        else:
            sum = sum + k**3
